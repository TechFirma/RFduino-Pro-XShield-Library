/*************************************************************
  This is a library for the RFduino Pro XShield Port Expander
  Tech Firma, LLC

  Derived from the Adafruit_MCP23017 library:
...
#ifndef _RFduinoProXShield_H_
#define _RFduinoProXShield_H_

// Don't forget the Wire library
class RFduinoProXShield {
public:

  // Tech Firma, LLC - RFduinoProXShield
  void begin(uint8_t addr, uint8_t analog);

  void begin(uint8_t addr);
  void begin(void);

  // Tech Firma, LLC - RFduinoProXShield
  void portABMode(uint8_t d);
